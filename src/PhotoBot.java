...
public class PhotoBot extends TelegramLongPollingBot {
    ...
    public void onUpdateReceived(Update update) {
        ...
        if (update.hasMessage() && update.getMessage().hasText()) {
            ...
            if (message_text.equals("/start")) {
            ...
            } else if (message_text.equals("/mycar")) {
                // User sent /pic
                SendPhoto msg = new SendPhoto()
                        .setChatId(chat_id)
                        .setPhoto("AgADBAADX6sxG1f42VNkOpCVa4K-1Gw-JhoABLdeOInbGg3o9LUDAAEC") //TO BE REMOVED LATER
                        .setCaption("Photo");
                try {
                ...
                SendPhoto msg = new SendPhoto()
                        .setChatId(chat_id)
                        .setPhoto("AgADBAADX6wxG-EuwFPBvb4eTHOCkD0eIBoABHe85aevoqauFmwEAAEC")
                        .setCaption("Photo");
                try {
                    sendPhoto(msg); // Call method to send the photo
                } catch (TelegramApiException e) {
